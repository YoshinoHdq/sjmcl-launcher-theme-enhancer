(function () {
  ...
  var WN={clear:"晴天",cloudy:"多云",rain:"雨天",snow:"雪天",thunder:"雷暴",fog:"雾天",wind:"大风"};
  ...
  window.registerExtension(function (api) {
      ...
      return el(Box,{
        ...
        el(VStack,{spacing:3,align:"stretch",position:"relative",zIndex:1},
          el(HStack,{justify:"space-between",align:"center"},
            el(HStack,{spacing:2},
              el(Text,{fontSize:"xs",fontWeight:"bold",color:"white",letterSpacing:"0.5px",textTransform:"uppercase"},"城市天气"),
            ),
          ...
          wea?el(Box,{
            ...
            el(VStack,{spacing:2,align:"center"},
              ...
              el(HStack,{spacing:4,justify:"center"},
                el(VStack,{spacing:0,align:"center"},
                  el(Text,{fontSize:"10px",color:"rgba(255,255,255,0.4)",textTransform:"uppercase"},"湿度"),
                  el(Text,{fontSize:"14px",color:"white",fontWeight:"600"},wea.humi+"%")),
                el(VStack,{spacing:0,align:"center"},
                  el(Text,{fontSize:"10px",color:"rgba(255,255,255,0.4)",textTransform:"uppercase"},"风速"),
                  el(Text,{fontSize:"14px",color:"white",fontWeight:"600"},wea.wind+" km/h")),
                wea.feels?el(VStack,{spacing:0,align:"center"},
                  el(Text,{fontSize:"10px",color:"rgba(255,255,255,0.4)",textTransform:"uppercase"},"体感"),
            ...
            el(Text,{fontSize:"sm",color:"rgba(255,255,255,0.4)"},
              city[0]?el("span",null,"加载天气中..."):el("span",null,"搜索城市"))
          ),
          // Atmosphere toggle
          el(HStack,{justify:"space-between",align:"center"},
            el(Text,{fontSize:"xs",color:"rgba(255,255,255,0.5)"},"氛围效果"),
          ...
          el(HStack,{justify:"space-between",align:"center"},
            el(Text,{fontSize:"xs",color:"rgba(255,255,255,0.5)"},"粒子效果"),
    ...
    var THEME_OPTIONS=[
      {v:"rain",l:"🌧️ 雨天"},{v:"snow",l:"❄️ 雪天"},{v:"sand",l:"🌪️ 沙暴"},
      {v:"stars",l:"🌌 星空"},{v:"aurora",l:"🌌 极光"},{v:"leaves",l:"🍃 落叶"},
      {v:"water",l:"🌊 水下"},{v:"fire",l:"🔥 火焰"},{v:"sunset",l:"🌅 日落"},{v:"mc",l:"🎮 Minecraft"}
    ];
    ...
    function ThemeEnhancerWidget(){
      ...
      return el(Box,{p:4,borderRadius:"2xl",bg:"rgba(8,12,24,0.9)",backdropFilter:"blur(4px)",border:"1px solid rgba(255,255,255,0.1)"},
        el(VStack,{spacing:3,align:"stretch"},
          // Header
          el(HStack,{justify:"space-between",align:"center"},
            el(Text,{fontSize:"xs",fontWeight:"bold",color:"white",letterSpacing:"0.5px",textTransform:"uppercase"},"主题增强"),
            el(HStack,{spacing:2},
              el(Badge,{colorScheme:_trun?"green":"gray",variant:"solid",fontSize:"xs",borderRadius:"full",px:2},
                _trun?"开":"关"),
              vs.active?el(Badge,{colorScheme:"blue",variant:"solid",fontSize:"xs",borderRadius:"full",px:2},"视频"):null
            )
          ),
          ...
          el(Box,{p:2,borderRadius:"lg",bg:"rgba(255,255,255,0.04)",border:"1px solid rgba(255,255,255,0.06)"},
            el(HStack,{spacing:2,align:"center"},
              vs.active
                ...
                : el(Button,{size:"sm",colorScheme:"green",w:"100%",onClick:pickVideoFile,fontSize:"12px",borderRadius:"lg"},"📁 选择视频文件"),
        ...
        el(VStack,{spacing:6,align:"stretch"},
          ...
          el(Box,null,
            el(HStack,{spacing:2,mb:3,align:"center"},
              ...
              el(Heading,{size:"sm",color:"white",fontWeight:"600"},"🌤️ 城市天气")
            ),
                ...
                vs.active
                  ? el(VStack,{spacing:2,align:"stretch"},
                      el(HStack,{spacing:2},
                        ...
                        el(Button,{size:"sm",colorScheme:"green",flex:1,borderRadius:"10px",onClick:pickVideoFile},"📁 更换"),
                        el(Button,{size:"sm",colorScheme:"red",flex:1,borderRadius:"10px",onClick:function(){videoKill()}},"🗑️ 移除")
                      ),
                      el(Box,null,
                        el(Text,{fontSize:"sm",color:"gray.300",mb:1},"音量: "+Math.round(vs.vol*100)+"%"),
                  ...
                  : el(Button,{size:"lg",colorScheme:"green",w:"100%",py:5,borderRadius:"xl",onClick:pickVideoFile},
                      el(VStack,{spacing:1,align:"center"},
                        ...
                        el(Text,{fontSize:"sm",fontWeight:"500"},"选择一个视频文件"),
          ...
          el(Box,null,
            el(HStack,{spacing:2,mb:3,align:"center"},
              ...
              el(Heading,{size:"sm",color:"white",fontWeight:"600"},"✨ 主题粒子特效")
            ),
            el(Box,{p:3,borderRadius:"lg",bg:"rgba(255,255,255,0.04)",border:"1px solid rgba(255,255,255,0.06)"},
              el(VStack,{spacing:3,align:"stretch"},
                el(HStack,{justify:"space-between",align:"center"},
                  el(Text,{fontSize:"sm",color:"gray.300",fontWeight:"500"},"特效类型"),
                ...
                el(Box,null,
                  el(HStack,{justify:"space-between"},
                    el(Text,{fontSize:"sm",color:"gray.300"},"强度"),
          ...
          el(Box,{p:3,borderRadius:"lg",bg:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.06)"},
            el(VStack,{spacing:1,align:"stretch"},
              el(Text,{fontSize:"xs",color:"gray.500"},"主题增强插件 v0.1.0"),
              el(Text,{fontSize:"xs",color:"gray.500"},"作者：hemekewayoshino"),
              el(Box,{h:"1px",bg:"rgba(255,255,255,0.06)",my:1}),
              el(Text,{fontSize:"xs",color:"gray.500"},"图层顺序：视频(z:0) → 天气(z:1) → 主题(z:2)")
            )
          )
        )
      );
